...
project {
    buildType(ChocolateyCcrExtension)
}

object ChocolateyCcrExtension : BuildType({
    id = AbsoluteId("ChocolateyCCRExtension")
    name = "Build"
    ...
    params {
        ...
        param("env.Git_Branch", "%teamcity.build.vcs.branch.ChocolateyCCRExtension_CommunityCCRExtVcsRoot%")
