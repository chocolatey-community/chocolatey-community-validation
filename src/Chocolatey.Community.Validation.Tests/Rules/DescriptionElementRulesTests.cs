...
<package xmlns=""http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd"">
  ...
  <files />
        ...
        [Test]
        public async Task ShouldFlagWhenDescriptionIsExactly30Characters()
        {
            var testContent = GetTestContent("in metus vulputate eu sceleris");

            await VerifyNuspec(testContent);
        }

        [Test]
        public async Task ShouldFlagWhenDescriptionIsLessThan30Characters()
        {
            var testContent = GetTestContent("Some Short Description");

            await VerifyNuspec(testContent);
        }

        [Test]
        public async Task ShouldFlagWhenDescriptionIsLessThan30CharactersAfterTrimming()
        {
            var testContent = GetTestContent("     in metus vulputate eu     ");
